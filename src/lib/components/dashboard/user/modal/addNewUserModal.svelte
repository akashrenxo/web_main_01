<script lang="ts">
    ...
    const handleSubmit = () => {
        console.log("hi");
        console.log(passwordsMatch, username, password);
        if (passwordsMatch) {
            ...
            <div class="mt-4 space-y-4 lg:mt-5 md:space-y-5">
                <div>
                    ...
                    <input
                        ...
                        bind:value={username}
                        class="bg-gray-50 placeholder:text-xs border text-xs border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                    />
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input
                            id="password"
                            name="password"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 pr-10"
